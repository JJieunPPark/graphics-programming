...
void glm_transform_test() {
  ...
  glm::mat4 mat_Translate;//끝
  glm::mat4 mat_Scale;//끝
  glm::mat4 mat_Rotate;//끝
  glm::mat4 mat_LookAt;
  glm::mat4 mat_Ortho;
  ...
  // TODO 9)
  mat_Translate = glm::translate(glm::mat4(1), glm::vec3(1, -1, 2));
  mat_Rotate = glm::rotate(glm::mat4(1), glm::radians(90), glm::vec3(1, 2, -1));
  mat_Scale = glm::scale(glm::mat4(1), glm::vec3(2, 1, 1.5));
  mat_LookAt = glm::lookAt(glm::vec3(0, 0, -5), glm::vec3(0, 0, 0), glm::vec3(0, 1, 0));
  mat_Ortho = glm::ortho(1, -1, 1, -1, 1, -1);
  mat_Frustum = glm::frustum(-0.1f, 0.1f, -0.1f, 0.1f, 0.1f, 1000.0f);
  mat_Perspective = glm::perspective(glm::radians(60), 1, 0.001f, 10000.0f);
