...
void Camera::set_pose(const glm::vec3& _pos,
    const glm::vec3& _at,
    const glm::vec3& _up_dir)
{
...
const glm::mat4 Camera::get_projection_matrix() const
{
    ...
    {
        return glm::perspective(glm::radians(fovy_),
            aspect_,
            near_,
            far_);
    }
    ...
    {
        return glm::ortho(-aspect_ * ortho_scale_,
            aspect_ * ortho_scale_,
            -ortho_scale_,
            ortho_scale_,
            near_,
            far_);
